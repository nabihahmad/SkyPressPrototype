...
public class AboutUsActivity extends AppCompatActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getAboutUsInfoFromXML();
	}

	private void getAboutUsInfoFromXML(){
		AboutUsInfoPopulator aboutUsInfoPopulator = new AboutUsInfoPopulator(this);
		aboutUsInfoPopulator.execute();
	}
